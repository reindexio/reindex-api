module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c8 = function(call_parameters) {
              return call_parameters;
            },
        peg$c9 = function(p) { return p },
        peg$c10 = function(first, rest) { return first.merge.apply(first, rest); },
        peg$c11 = function(parameter_list) {
              return parameter_list;
            },
        peg$c12 = ":",
        peg$c13 = { type: "literal", value: ":", description: "\":\"" },
        peg$c14 = function(name, parameter) {
        ...
        peg$c19 = function(children) {
              return children;
            },
        peg$c20 = function(first, rest) {
                return [first].concat(rest);
              },
        peg$c21 = function(name, alias) {
              return new AST.GQLLeaf({
                name: name,
                alias: alias === null ? undefined : alias,
              });
            },
        peg$c22 = function(name, parameters, alias) {
              return new AST.GQLLeaf({
                name: name,
                alias: alias === null ? undefined : alias,
        ...
        peg$c23 = function(name, alias, children) {
        ...
        peg$c24 = function(name, parameters, alias, children) {
              return new AST.GQLNode({
                name: name,
                alias: alias === null ? undefined : alias,
                parameters: parameters,
        ...
        peg$c34 = function(prefix, suffix) {
    ...
    function peg$parsechildren() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parseproperty_separator();
        if (s2 === peg$FAILED) {
          s2 = peg$c5;
        }
        if (s2 !== peg$FAILED) {
    ...
    function peg$parsesimple_call_property() {
      var s0, s1, s2, s3, s4, s5;
